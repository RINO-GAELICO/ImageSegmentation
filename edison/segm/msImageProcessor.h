...
public:
 ...
 /*\/\/\/\/\/\/\/\/\/\/\/\/\/*/
  ...
  void DefineImage(const byte*,imageType, int, int);
 ...
 /*\/\/\/\/\/\/\/\/\/*/
  ...
  void Filter(int, float, Implementation);
 ...
 /*\/\/\/\/\/\/\/\/\/\/*/
  ...
  void Segment(int, float, int, Implementation);
  ...
  void RGBtoLUV(const byte*, float*);
...
private:
  ...
  //========================
   ...
   //DUCCIO's SECTION
   void FilterSerial(float sigmaS, float sigmaR);


   void Filter_omp(float sigmaS, float sigmaR);


   void Filter_cuda(float sigmaS, float sigmaR);
   //END DUCCIO's SECTION
